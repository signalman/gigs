    ...
    static class InitUserService{
        ...
        public void init(){
            ...
            for(int i=0; i < 100; i++){
                ...
                //스타 더미데이터 생성
                Star star1 = new Star(null, user1, "starName1", "women", 3, "소개글...", 2, true, 2.1, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
                Star star2 = new Star(null, user2, "starName2", "men", 1, "소개글...", 3, true, 4.2, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
                Star star3 = new Star(null, user3, "starName3", "men", 6, "소개글...", 3, true, 3.3, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
                Star star4 = new Star(null, user4, "starName4", "women", 2, "소개글...", 20, true, 2.5, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
