...
//
//import static gigsproject.gigs.domain.StageType.BAR;
//import static gigsproject.gigs.domain.StageType.SCHOOL;
...
//
//    @Test
//    @DisplayName("무대 타입 별 조회")
//    void getStages_type() throws Exception {
//        //given
//        //동일한 host의 post 30개를 생성, 이를 페이징 처리하여 조회
//        Host host = Host.builder()
//                .stageName("abc")
...
//                .build();
//
//        stageSearch.getStageTypes().add(BAR);
//
//        List<StageCard> responseList = postService.getList(stageSearch);
//
//        //then
